...
export const model = [
  { name: 'id', type: 'TextInput', group: 'info', listWidth: { min: '60' }, isEditable: false, isListable: true, isNumSentitive: true, isEditEntry: true, order: { editor: 0 }, },
  ...
  { name: 'status', type: 'RadioItem', group: 'info', listWidth: { min: '50' }, isEditable: false, isListable: true, options: publish_status_options, order: { editor: 0 }, isButtonized: true, isSchedulable: true, },
  ...
  { name: 'totalVote', type: 'TextInput', group: 'info', listWidth: { min: '80' }, isEditable: false, isListable: true, isNumSentitive: true, order: { editor: 1, }, },
