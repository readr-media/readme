...
export const model = [
  ...
  { name: 'heroImage', type: 'AssetPicker', width: { list: '180', editor: '200' }, isEditable: true, isListable: false, order: { editor: 4 }, },
  { name: 'ogImage', type: 'AssetPicker', width: { list: '180', editor: '200' }, isEditable: true, isListable: false, order: { editor: 4 }, acceptedFileTypes: [ 'image/*' ], },
