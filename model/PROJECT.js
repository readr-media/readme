...
export const model = [
  ...
  { name: 'updatedAt', type: 'Datetime', listWidth: { min: '140' }, isEditable: false, isListable: false, isDatetimeSentitive: true, order: { editor: 5, list: 6 }, },
  { name: 'createdAt', type: 'Datetime', isEditable: false, isListable: true, isDatetimeSentitive: true, order: { editor: 5 }, },
