...
export const model = [
  ...
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: true, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 0 } }, autocomplete: authorAutoComplete, order: { list: 1 }, },
