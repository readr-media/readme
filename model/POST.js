...
export const model = [
  ...
  { name: 'projectId', type: 'Dropdownlist', group: 'basic', width: { list: '110', editor: '400' }, isEditable: true, isListable: true, isNumSentitive: true, fetchSource, default: '0', defaultText: 'NA' },
