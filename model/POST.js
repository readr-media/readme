...
export const model = [
  ...
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_reporter', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: true, required: true, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 0 } }, autocomplete: authorAutoComplete, order: { list: 1 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_editor', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 1 } }, autocomplete: authorAutoComplete, order: { list: 2 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_designer', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 2 } }, autocomplete: authorAutoComplete, order: { list: 3 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_engineer', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 3 } }, autocomplete: authorAutoComplete, order: { list: 4 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_photographer', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 4 } }, autocomplete: authorAutoComplete, order: { list: 5 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_film', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 5 } }, autocomplete: authorAutoComplete, order: { list: 6 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_cleaner', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 6 } }, autocomplete: authorAutoComplete, order: { list: 7 }, },
  { name: 'authors', type: 'TextAuthorItem', group: 'basic', i18nKey: 'authors_analyst', listWidth: { min: '130', max: '200' }, isEditable: true, isListable: false, required: false, map: { name: 'nickname', value: 'id', member_id: 'id', optionalProperty: { author_type: 7 } }, autocomplete: authorAutoComplete, order: { list: 8 }, },
