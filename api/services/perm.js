...
const isReqAllowed = req => {
  console.log(`Checking if the req is aythorized.\nHost: ${req.identifier}\nisReqAllowed: ${get(config, [ 'AVAILABLE_MODELS', req.identifier ], false) && true}`)  
  console.log('Current config:', config.CONFIG_ID)
