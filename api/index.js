...
router.get('/available-ms', (req, res) => {
  ...
  console.log('get(CONFIG, `AVAILABLE_MODELS`)', get(CONFIG, `AVAILABLE_MODELS`))
  console.log('get(CONFIG, `AVAILABLE_MODELS.${req.identifier}`, [])', get(CONFIG, `AVAILABLE_MODELS.${req.identifier}`, []))
