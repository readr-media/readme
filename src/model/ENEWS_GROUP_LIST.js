...
export const subModel = [
  ...
  { name: 'mail', type: 'TextInput', width: { list: '250', editor: '200' }, isEditable: true, isListable: true, isInitiliazible: true, isEditEntry: true, },
  { name: 'nickname', type: 'TextInput', width: { list: '200', editor: '500' }, isEditable: true, isListable: true, isInitiliazible: true, },
